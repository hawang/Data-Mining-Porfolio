...
perl selectAttrs.pl winequality-both-fourqual-training.arff $ARGSTR > tmp12.train.arff
perl selectAttrs.pl winequality-both-fourqual-test.arff $ARGSTR > tmp12.test.arff
 
# Run the weka program
./runModels.sh "$ARGSTR" tmp11.train.arff tmp12.test.arff
