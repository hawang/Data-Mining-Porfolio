...
perl selectAttrs.pl winequality-both-fourqual-training.arff $ARGSTR > tmp6.train.arff
perl selectAttrs.pl winequality-both-fourqual-test.arff $ARGSTR > tmp6.test.arff
